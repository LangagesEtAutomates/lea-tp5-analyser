...
public final class LexerTest {
	...
	void keywords_allCore() {
		...
		.assertMatches(
				...
				Terminal.POUR, Terminal.DE, Terminal.A, Terminal.PAS,
				Terminal.ECRIRE
				);
	}
	...
	void punctuation_and_assignment() {
		new LeaAsserts("<- : ; ( )")
		.assertMatches(
				Terminal.AFFECTATION, Terminal.DEUX_PT, Terminal.PT_VIRG,
				Terminal.PAR_G, Terminal.PAR_D);
	}

	@Test
	void operators_and_logicals() {
		new LeaAsserts("+ - * = < et ou non")
		.assertMatches(
				Terminal.PLUS, Terminal.MOINS, Terminal.MULTIPLIE,
				Terminal.EGAL, Terminal.INFERIEUR,
				Terminal.ET, Terminal.OU, Terminal.NON);
	}
